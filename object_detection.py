...
#importing the model faster_rcnn_inception_v2_coco
!cp -avr /content/drive/My\ Drive/object/faster_rcnn_inception_v2_coco.config /content/edge

#cloning the research directory
%cd /content/models/research
import os
import shutil
import glob
...
#training the model
pipeline_fname = '/content/models/research/object_detection/edge/faster_rcnn_inception_v2_coco.config'
